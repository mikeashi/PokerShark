...
//%HM_Card+3
/// <exclude/>
public class HM_Card : TOKEN{ public override string yyname { get { return "HM_Card";}}
/// <exclude/>
public override int yynum { get { return 3; }}
/// <exclude/>
 public HM_Card(Lexer yyl):base(yyl) {}}
/// <exclude/>
public class HM_Card_1 : HM_Card {
  /// <exclude/>
  public HM_Card_1(Lexer yym):base(yym) 		{yylval = yytext.Clone();}}
//%Card169+5
/// <exclude/>
...
613,5,0,0};
 ...
 new Tfactory(this,"HM_Card_1",new TCreator(HM_Card_1_factory));
 ...
 new Tfactory(this,"HM_Card",new TCreator(HM_Card_factory));
...
/// <exclude/>
public static object HM_Card_1_factory(Lexer yyl) { return new HM_Card_1(yyl);}
/// <exclude/>
...
/// <exclude/>
public static object HM_Card_factory(Lexer yyl) { return new HM_Card(yyl);}
/// <exclude/>
